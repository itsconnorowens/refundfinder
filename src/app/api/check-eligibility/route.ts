...
// import { createEligibilityCheck } from '@/lib/airtable';
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Store check in Airtable (if configured)
    // TODO: Add Eligibility_Checks table to Airtable and implement createEligibilityCheck
    try {
