        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <Card className="bg-white/90 border-gray-200">
            <CardContent className="pt-6 text-center">
              <h2 className="text-2xl font-bold text-red-600 mb-4">Error: Missing Claim ID</h2>
    ...
    <div className="min-h-screen bg-slate-950 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card className="bg-white/90 border-gray-200 mb-8">
          ...
          <CardContent>
            {/* Claim Details */}
            <div className="bg-white/60 border border-gray-200 rounded-lg p-6 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex items-center text-gray-700">
                  ...
                  <Badge className="ml-2 bg-purple-500">Processing</Badge>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-2">We Review Your Claim</h4>
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-2">We File With Airline</h4>
                  <p className="text-sm text-gray-600">
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-2">You Get Updates</h4>
                  <p className="text-sm text-gray-600">
            ...
            {/* Timeline */}
            <div className="mt-8 bg-white/60 border border-gray-200 rounded-lg p-6">
        ...
        <Card className="bg-white/90 border-gray-200">
          <CardContent className="pt-6">
            <div className="text-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">100% Refund Guarantee</h3>
